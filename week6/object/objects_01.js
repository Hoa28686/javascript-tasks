...
let library=[
    ...
    {title:'The Psychology of Money',author:'Morgan Housel',yearPublished: 2020},
]
...
const book3=new Book('The Code Chronicles','Alex J. Harper',2023,["Technology", "Programming", "Self-Improvement"]);
library.push(book3);
console.log(library);
/* Task 5
...
const book4 = createBook('All the Light We Cannot See','Anthony Doerr',2021,["Historical Fiction", "War Fiction", "Literary Fiction", "Coming-of-Age"]);
console.log(book4)
/* Task 6
...
const students = [
    ...
    { name: "Bob", age: 19, grade: 98 },
    { name: "Charlie", age: 17, grade: 70}
  ];
students.forEach(s=>{
    if (s.grade>90){
        console.log(s.name);
...
const userProfiles = [
    ...
    { username: "jane_smith", email: "jane@example.com", isAdmin: false }
  ];
function adminCheck(){
...
console.log('12.');
const orders = [
    { orderId: 101, customerName: "Alice Johnson", totalAmount: 250.75, status: "completed" },
    { orderId: 102, customerName: "Bob Smith", totalAmount: 89.99, status: "pending" },
    { orderId: 103, customerName: "Charlie Brown", totalAmount: 150.50, status: "completed" },
    { orderId: 104, customerName: "David Lee", totalAmount: 300.00, status: "pending" }
  ];
...
const smartphone = {
  ...
  const check5G=smartphone=>{
    (smartphone.is5GEnabled)?console.log('This phone supports 5G.'):console.log('This phone does notsupport 5G.')
  }
  check5G(smartphone);
/* Task 14
...
console.log('15.');
const employees = [
    { name: "Alice Johnson", position: "Software Engineer", salary: 80000 },
    { name: "Bob Smith", position: "Project Manager", salary: 95000 },
    { name: "Charlie Brown", position: "UI/UX Designer", salary: 70000 },
    { name: "David Lee", position: "DevOps Engineer", salary: 85000 }
  ];
